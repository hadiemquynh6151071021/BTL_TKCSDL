...
CREATE TABLE TACGIA(
	...
	-->RBTV
	CONSTRAINT RBTV_PK_TACGIA PRIMARY KEY(MATG),
)
go
CREATE TABLE TACGIAVIETSACH(
	...
	CONSTRAINT RBTV_PF1_TACGIAVIETSACH FOREIGN KEY (MATG) REFERENCES TACGIA(MATG),
	CONSTRAINT RBTV_PF2_TACGIAVIETSACH FOREIGN KEY (MATRUYEN) REFERENCES TRUYEN(MATRUYEN)
...
CREATE TABLE DOCGIA(
	...
	CONSTRAINT RBTV_PK_DOCGIA PRIMARY KEY(MADG)
...
CREATE TABLE PHIEUMUON(
	...
	CONSTRAINT RBTV_PK_PHIEUMUON PRIMARY KEY(MAPHIEUMUON),
	CONSTRAINT RBTV_PF_PHIEUMUON FOREIGN KEY (MADG) REFERENCES DOCGIA(MADG)
)
go
CREATE TABLE DANHSACHMUON(
	...
	CONSTRAINT RBTV_SOLUONG_DANHSACHMUON CHECK (SOLUONG>0),
	CONSTRAINT RBTV_PF1_DANHSACHMUON FOREIGN KEY (MATRUYEN) REFERENCES TRUYEN(MATRUYEN),
	CONSTRAINT RBTV_PF2_DANHSACHMUON FOREIGN KEY (MAPHIEUMUON) REFERENCES PHIEUMUON(MAPHIEUMUON)
)
go
...
CREATE TABLE QUANLYTRUYEN(
	...
	-->RBTV
	CONSTRAINT RBTV_PF1_QUANLYTRUYEN FOREIGN KEY (MANV) REFERENCES NHANVIEN(MANV),
	CONSTRAINT RBTV_PF2_QUANLYTRUYEN FOREIGN KEY (MATRUYEN) REFERENCES TRUYEN(MATRUYEN)
...
CREATE TABLE QUANLYPHIEUMUON(
	...
	CONSTRAINT RBTV_PF1_QUANLYPHIEUMUON FOREIGN KEY (MANV) REFERENCES NHANVIEN(MANV),
	CONSTRAINT RBTV_PF2_QUANLYPHIEUMUON FOREIGN KEY (MAPHIEUMUON) REFERENCES PHIEUMUON(MAPHIEUMUON)
)
