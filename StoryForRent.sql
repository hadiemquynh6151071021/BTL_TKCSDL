...
ALTER TABLE TRUYEN
ADD CONSTRAINT RBTV_FK_TRUYEN FOREIGN KEY(MATG) REFERENCES TACGIA(MATG)
...
ALTER TABLE PHIEUMUON
ADD CONSTRAINT RBTV_FK_PHIEUMUON FOREIGN KEY (MADG) REFERENCES DOCGIA(MADG)

ALTER TABLE DANHSACHMUON
ADD CONSTRAINT RBTV_SOLUONG_DANHSACHMUON CHECK (SOLUONG>0)

ALTER TABLE DANHSACHMUON
ADD CONSTRAINT RBTV_FK1_DANHSACHMUON FOREIGN KEY (MATRUYEN) REFERENCES TRUYEN(MATRUYEN)

ALTER TABLE DANHSACHMUON
ADD CONSTRAINT RBTV_FK2_DANHSACHMUON FOREIGN KEY (MAPHIEUMUON) REFERENCES PHIEUMUON(MAPHIEUMUON)

ALTER TABLE QUANLYTRUYEN
ADD CONSTRAINT RBTV_FK1_QUANLYTRUYEN FOREIGN KEY (MANV) REFERENCES NHANVIEN(MANV)

ALTER TABLE QUANLYTRUYEN
ADD CONSTRAINT RBTV_FK2_QUANLYTRUYEN FOREIGN KEY (MATRUYEN) REFERENCES TRUYEN(MATRUYEN)

ALTER TABLE QUANLYPHIEUMUON
ADD CONSTRAINT RBTV_FK1_QUANLYPHIEUMUON FOREIGN KEY (MANV) REFERENCES NHANVIEN(MANV)

ALTER TABLE QUANLYPHIEUMUON
ADD CONSTRAINT RBTV_FK2_QUANLYPHIEUMUON FOREIGN KEY (MAPHIEUMUON) REFERENCES PHIEUMUON(MAPHIEUMUON)
